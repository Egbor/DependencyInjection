...
namespace DependencyInjection
{
    ...
    public class DependenciesConfiguration
    {
        ...
        public void Register<TDependency, TImplementation>(bool isSealed = false) where TImplementation : TDependency
        {
            Register(typeof(TDependency), typeof(TImplementation));
        }

        public void Register(Type dependency, Type implementation, bool isSealed = false)
        {
            ...
            {
                implementations.Add(isSealed ? new DependencySealedImplementation(implementation) : new DependencyImplementation(implementation));
            }
        }
